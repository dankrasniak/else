...
#region PropperFunctionality
        ...
        {
            var tested = new StateVector(1.0, 2.0, 3.0, 4.0);
            var addition = new StateVector(1.0, 2.0, 3.0, 4.0);

            tested = tested + addition;
            var expectedResult = new StateVector(2.0, 4.0, 6.0, 8.0);
        ...
        {
            var copied = new StateVector(1.0, 2.0, 3.0, 4.0);
            var tested = new StateVector(copied);
